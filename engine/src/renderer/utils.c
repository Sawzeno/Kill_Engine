...
void logVulkanFrameBuffer(const struct vulkanFrameBuffer* framebuffer) {
    ...
    // Print details of attachments if needed
    // UINFO("  Attachments: ...");
...
void logVulkanSwapchain(const vulkanSwapchain* swapchain) {
    ...
    UINFO("  Image Format: %d", swapchain->imageFormat.format); // Assuming you want to print the format
...
void logVulkanSwapchainSupportInfo(const vulkanSwapchainSupportInfo* supportInfo) {
    ...
    // Print capabilities, formats, and present modes if needed
    UINFO("  Capabilities: ..."); // Assuming you have a function to log surface capabilities
    for (u32 i = 0; i < supportInfo->formatCount; ++i) {
        UINFO("  Format[%u]: ...", i); // Assuming you have a function to log surface format
    }
    for (u32 i = 0; i < supportInfo->presentModesCount; ++i) {
        UINFO("  Present Mode[%u]: ...", i); // Assuming you have a function to log present mode
    }
...
void logVulkanDevice(const vulkanDevice* device) {
    ...
    logVulkanSwapchainSupportInfo(&device->swapchainSupport);
    ...
    // Print device properties, features, and memory properties if needed
    UINFO("  Properties: ..."); // Assuming you have a function to log device properties
    UINFO("  Features: ...");   // Assuming you have a function to log device features
    UINFO("  Memory: ...");      // Assuming you have a function to log device memory properties
    UINFO("  Depth Format: %d", device->depthFormat); // Assuming you want to print the depth format
}
